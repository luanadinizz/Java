...
public class Agenda extends JFrame {
    ...
    public class Agenda implements Comparable<Contato>{

        //atributos e métodos
        
        @Override public int compareTo(Contato outroContato) { 
            if (this.Contato > outroContato.getContato()) { 
                return -1; 
                } if (this.Contato < outroContato.getContato()) { 
                return 1; 
                } 
         ...
         Collections.sort(listaContatos); System.out.println(listaContato);
        }        
